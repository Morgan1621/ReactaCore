...
-- SP_LISTAR_EVENTOS --
CREATE OR ALTER PROC SP_LISTAR_EVENTOS
AS
BEGIN
    SELECT
        E.EventoId,
        ...
        U.Correo AS CorreoOrganizador,
        Es.NombreEstado
    FROM Eventos E
    INNER JOIN Categorias C ON E.CategoriaId = C.CategoriaId
    INNER JOIN Organizadores O ON E.OrganizadorId = O.OrganizadorId
    INNER JOIN Usuarios U ON O.UsuarioId = U.UsuarioId
    INNER JOIN Estados Es ON E.EstadoId = Es.EstadoId;
END
GO
